...
<ul class="list">
    ...
    <li>
      ...
      [ <a href="file/EditAddressBook.php?AddressBook_ID=<?php echo $row['AddressBook_ID'] ?>">Edit</a> ]
      [ <a href="file/DeleteAddressBook.php?AddressBook_ID=<?php echo $row['AddressBook_ID'] ?>" class="del" >Delete</a> ]
